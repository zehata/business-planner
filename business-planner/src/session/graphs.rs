...
impl Session {
    ...
    pub fn add_node<I: NodeItem, G: Graph>(
        &mut self,
        node_id: &Uuid,
        graph_id: &Uuid,
    ) -> Result<(), Error> {
    ...
    pub fn remove_node<I: NodeItem, G: Graph>(
        &mut self,
        node_id: &Uuid,
        graph_id: &Uuid,
    ) -> Result<(), Error> {
    ...
    pub fn add_edge<E: EdgeItem, G: Graph>(
        &mut self,
        from_node_id: &Uuid,
        to_node_id: &Uuid,
        graph_id: &Uuid,
    ...
    pub fn remove_edge<E: EdgeItem, G: Graph>(
        &mut self,
        from_node_id: &Uuid,
        to_node_id: &Uuid,
        graph_id: &Uuid,
        ...
        let edge_id = graph
            ...
            .ok_or(GraphsError::GraphObjectMissing(GraphObjectMissing::Graph))?;
        E::delete(&edge_id, &mut self.persistent_data.registry)
            .ok_or(GraphsError::GraphObjectMissing(GraphObjectMissing::Graph))?;
